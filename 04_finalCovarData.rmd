...
load("C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\data_prelim_processing.rdata")
```
...
expertiseScore <- read_csv("C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\dataObsExpScore.csv") %>% 
...
landscape_files <- "C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\landcover\\landscape_resamp01km.tif"
...
chelsa_names <- c("bio1","bio2","bio3","bio4","bio5","bio6","bio7","bio8","bio9",
...
pmap(data_at_scale, function(sample_radius, data){
  write_csv(data, path = glue('C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\dataCovars_{str_pad(sample_radius/1e3, 2, pad = "0")}km.csv'))
  message(glue('export done: C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\dataCovars_{str_pad(sample_radius/1e3, 2, pad = "0")}km.csv'))
})
