...
```{r}
f_in_ebd <- file.path("D:\\Occupancy Modeling\\Data\\ebd_IN_relMay-2018.txt")
f_in_sampling <- file.path("D:\\Occupancy Modeling\\Data\\ebd_sampling_relMay-2018.txt")
```
...
```{r}
f_out_ebd <- "D:\\Occupancy Modeling\\Data\\ebd_Filtered_May2018.txt"
f_out_sampling <- "D:\\Occupancy Modeling\\Data\\ebd_sampling_Filtered_May2018.txt"
...
```{r}
#### Subset data and choose only the Black and orange flycatcher for now ####
...
library(sf)
hills = st_read("D:\\Occupancy Modeling\\Data\\Shapefiles\\Nil_Ana_Pal.shp")
...
#' sf
alt = raster::raster("D:\\Occupancy Modeling\\Data\\Elevation\\alt")
...
evifiles = list.files("D:\\Occupancy Modeling\\Data\\EVI\\", pattern = "_201", full.names = T)
...
### Sampling without replacement now explicitly mentioned in the code
...
dataSubsample = mutate(dataSubsample, jul.date = lubridate::yday(as.Date(observation_date)))
...
#'for each species, gather values preserving locality id, sampling_event_identifier, and species name, and assign a visit id 
...
#### Matching the environmental covariates with the locality ID for the dataframes created above
```{r}
fieldsToKeep = c("locality", "locality_type","locality_id",
                 "longitude", "latitude", "elevation",
                 "CHELSA_bio1_1979.2013_V1_1", "CHELSA_bio10_1979.2013_V1_1","CHELSA_bio11_1979.2013_V1_1",            "CHELSA_bio12_1979.2013_V1_1", "CHELSA_bio13_1979.2013_V1_1" , "CHELSA_bio14_1979.2013_V1_1",           
"CHELSA_bio15_1979.2013_V1_1", "CHELSA_bio16_1979.2013_V1_1", "CHELSA_bio17_1979.2013_V1_1",            "CHELSA_bio18_1979.2013_V1_1", "CHELSA_bio19_1979.2013_V1_1","CHELSA_bio2_1979.2013_V1_1",            
"CHELSA_bio3_1979.2013_V1_1", "CHELSA_bio4_1979.2013_V1_1", "CHELSA_bio5_1979.2013_V1_1",             "CHELSA_bio6_1979.2013_V1_1", "CHELSA_bio7_1979.2013_V1_1", "CHELSA_bio8_1979.2013_V1_1",            
"CHELSA_bio9_1979.2013_V1_1", "CHELSA_prec_interannual_1979.2013_V1_1","CHELSA_temp_interannual_1979.2013_V1_1",
...
dataCovarFinal <- cbind(dataCovarFields[1:5],env5)

dataCovarFinal <- as.data.frame(dataCovarFinal)
write_csv(dataCovarFinal,"D:\\Occupancy Modeling\\Scripts\\Occupancy Scripts\\dataCovarFinal.csv")
