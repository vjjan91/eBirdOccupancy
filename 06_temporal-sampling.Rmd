...
![Most sites are resurveyed at least once, but some are visited much more frequently than others. There does not appear to be a link between roads and visit frequency.](fig_temporal_bias)

## Main Text Figure 3

Combining figures for spatial and temporal clustering into main text figure 3.
...
![Observations peak in the early months of the year, and decline towards the rainy months, slowly increasing until the following winter.](fig_chk_per_month)
