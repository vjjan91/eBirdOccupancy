...
f_in_ebd <- file.path("C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\ebd_IN_relApr-2020.txt")
f_in_sampling <- file.path("C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\ebd_sampling_relApr-2020.txt")
```
...
f_out_ebd <- "C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\eBirdDataWG_filtered.txt"
f_out_sampling <- "C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\eBirdSamplingDataWG_filtered.txt"
```
...
columnsOfInterest <- c("checklist_id","scientific_name","common_name","observation_count","locality","locality_id","locality_type","latitude","longitude","observation_date","time_observations_started","observer_id","sampling_event_identifier","protocol_type","duration_minutes","effort_distance_km","effort_area_ha","number_observers","species_observed","reviewed")
...
library(sf)
hills <- st_read("C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\Shapefiles\\Nil_Ana_Pal.shp")
...
save(data, file = "C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\data_temp.rdata")
```
...
# save a temp data file
save(dataGrouped, file = "C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\data_prelim_processing.rdata")
