...
dat <- fread("D:\\Chapter 1_Occupancy Modeling\\Data\\SpeciesCovariateData\\dataCovars_25km.csv",header=T)
setDF(dat)
head(dat)
...
names(dat)
dat <- dat[,-c(1,4,5,18,20,37)] # check this once
...
names(dat) <- c("duration_minutes", "effort_distance_km","locality", "locality_type",
                  ...
                  "number_observers","longitude", "latitude","pres_abs","expertise",
                  "alt.y","slope.y","aspect.y","evi.jan.y","evi.july.y","evi.oct.y", "bio_4.y","bio_17.y","bio_18.y","prec_interannual.y","temp_interannual.y",
                  "lc_03.y", "lc_06.y", "lc_02.y","lc_01.y", "lc_04.y","lc_07.y", "lc_05.y",
...
dat.scaled <- dat.1
dat.scaled[,c(1,2,11,15:35)] <- scale(dat.scaled[,c(1,2,11,15:35)]) # Scaling and standardizing detection and site-level covariates
fwrite(dat.scaled, file = "D:\\Chapter 1_Occupancy Modeling\\Data\\SpeciesCovariateData\\scaledCovs_25km.csv")
...
dat.scaled <- fread("D:\\Chapter 1_Occupancy Modeling\\Data\\SpeciesCovariateData\\scaledCovs_2.5km.csv", header=T)
setDF(dat.scaled)
head(dat.scaled)
