...
dat <- fread("C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\dataCovars_2.5km.csv",header=T)
setDF(dat)
head(dat)
...
names(dat) <- c("duration_minutes", "effort_distance_km","locality", "locality_type",
                  "locality_id", "observer_id", "observation_date", "scientific_name", "observation_count", "protocol_type","number_observers","pres_abs","tot_effort","longitude", "latitude","expertise","alt.y","slope.y","aspect.y","bio1.y","bio2.y","bio3.y","bio4.y","bio5.y", "bio6.y", "bio7.y", "bio8.y","bio9.y" ,"bio10.y" , "bio11.y" ,"bio12.y" ,"bio13.y" , "bio14.y","bio15.y" ,"bio16.y" , "bio17.y" ,"bio18.y", "bio19.y","lc_02.y", "lc_03.y", "lc_06.y","lc_01.y", "lc_04.y","lc_07.y", "lc_05.y",
...
dat.scaled <- dat.1
dat.scaled[,c(1,2,11,16:47)] <- scale(dat.scaled[,c(1,2,11,16:47)]) # Scaling and standardizing detection and site-level covariates
fwrite(dat.scaled, file = "C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\scaledCovs_2.5km.csv")
...
names(dat.scaled)
screen.cor(dat.scaled[,c(1,2,11,16:47)], threshold = 0.5)
...
## Get the AIC values for the top models
