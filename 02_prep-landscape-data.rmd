...
# to 1km from 10m
gdalUtils::gdalwarp(srcfile = landcover, 
...
env_data_resamp <- projectRaster(from = env_data, to = lc_data, 
...
# make labeller
chelsa <- c(bio_01 = "Annual Mean Temperature (°C)",
...
![Climatic variables as a function of elevation, in increments of 200m. Points represent means, while vertical lines show 95% confidence intervals.]("figs/fig_climate_elev.png")
...
# fill out lc elev
lc_elev_canon <- crossing(elev = unique(lc_elev$elev),
...
ggsave(fig_lc_elev, filename = "figs/fig_lc_elev.png", 
       height = 2, width = 6, device = png(), dpi = 300); dev.off()
```

![Proportional landcover, as a function of elevation in the study site. Data represent elevation in increments of 100m.](figs/fig_lc_elev.png)

### Figure 2: Climate ~ elevation and landcover ~ elevation
...
```{r}
fig_clim_lc_elev <-
  wrap_plots(fig_climate_elev, fig_lc_elev, ncol = 1,
             design = "AA\nAA\nBB")+
...
# save
ggsave(fig_clim_lc_elev, filename = "figs/fig_02_clim_lc_elev.png",
       dpi = 300,
