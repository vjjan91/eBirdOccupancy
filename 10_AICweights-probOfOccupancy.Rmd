...
species <- read_csv("data/species_list.csv") %>%
  filter(
    !scientific_name %in% c(
      "Pellorneum ruficeps", "Prinia hodgsonii", "Hypothymis azurea",
      "Chalcophaps indica", "Dendrocitta leucogastra", "Terpsiphone paradisi",
      "Rubigula gularis", "Dicrurus aeneus", "Muscicapa dauurica",
      "Chrysocolaptes guttacristatus", "Oriolus kundoo", "Cyornis tickelliae",
      "Alcippe poioicephala", "Geokichla citrina", "Orthotomus sutorius",
...
data_predictor <- mutate(model_data,
  ...
  filter(predictor != "Int", predictor != "Ibio4a^2" &
    predictor != "Ibio15a^2") %>%
