...
```{r }
# list of species
# Removing two species after running a chi-square goodness of fit test
species <- read_csv("data/species_list.csv") %>%
  filter(
    !scientific_name %in% c(
      "Prinia hodgsonii", "Pellorneum ruficeps","Hypothymis azurea",
      "Dicrurus aeneus", "Dendrocitta leucogastra","Chalcophaps indica",
      "Rubigula gularis","Oriolus xanthornus", "Alcippe poioicephala",
      "Muscicapa dauurica", "Geokichla citrina", "Chrysocolaptes guttacristatus",
      "Terpsiphone paradisi", "Oriolus kundoo", "Cyornis tickelliae",
      "Cinnyris lotenius", "Dicrurus paradiseus", "Psittacula columboides",
      "Saxicola caprata","Yungipicus nanus"))
...
data_predictor <- mutate(model_data,
  ...
  filter(predictor != "Int", predictor != "Ibio_1^2" &
    predictor != "Ibio_12^2") %>%
...
![**Relative importance of environmental predictors and species-specific associations.**
