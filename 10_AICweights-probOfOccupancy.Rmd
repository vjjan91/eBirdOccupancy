...
species <- read_csv("data/species_list.csv") %>%
  filter(
    !scientific_name %in% c(
      "Terpsiphone paradisi", "Prinia hodgsonii", "Pellorneum ruficeps",
      "Hypothymis azurea","Dicrurus aeneus","Chalcophaps indica",
      "Pericrocotus cinnamomeus","Rubigula gularis","Dendrocitta leucogastra",
      "Oriolus xanthornus","Muscicapa dauurica","Cyornis tickelliae",
