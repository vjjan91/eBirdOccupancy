...
sp_spec_data %>% 
  ...
  summarise_at(vars(nnb), list(~mean(.), ~ci(.))) %>% 
...
read_csv("data/results/dist_nnb_species_specific.csv") %>% 
  knitr::kable()
```
