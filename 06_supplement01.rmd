...
# I think this should be EPSG 32643 rather than 42
...
def convData(somedata):
    ...
    unique_locs = gpd.GeoDataFrame(somedata,
                                  ...
                                  somedata.latitude))
    unique_locs.crs = {'init' :'epsg:4326'}
    unique_locs = unique_locs.to_crs({'init': 'epsg:32642'}) # Same comment as above
...
```{r plot_figure1, eval=TRUE, echo=FALSE, fig.cap="Checklist locations across the Nilgiris, Anamalais and the Palani hills. Inset histogram shows checklists' distance to the nearest road, with the X-axis on a log-scale."}
# inset image here
