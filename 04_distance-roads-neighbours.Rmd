...
The code available in the 'readable version' is a conversion of a Jupyter notebook to an R Markdown notebook. This code will not run directly in R.

To run this code from R/RStudio, use the `reticulate` package, or refer to the `ipynb` file in the code repository to run the Python code instead.
