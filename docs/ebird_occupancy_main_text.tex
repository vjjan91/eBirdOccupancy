...
\begin{figure}
\centering
\includegraphics{figs/figLandcoverResample.png}
\caption{This is the wrong figure for sure.}
\end{figure}
...
\textbf{Does this table need a caption?}

\hypertarget{histograms-of-distance-to-nearest-site}{%
\subsection{Histograms of distance to nearest site}\label{histograms-of-distance-to-nearest-site}}
...
\hypertarget{table-nearest-site-where-the-species-was-seen}{%
\subsection{Table: Nearest site where the species was seen}\label{table-nearest-site-where-the-species-was-seen}}
...
\textbf{Is this figure necessary here?}

\begin{figure}
\centering
\includegraphics{figs/fig_nnb_species.png}
\caption{Histograms showing the species-specific distances to nearest neighbouring site.}
\end{figure}

\hypertarget{visualise-distance-to-roads-and-nearest-site}{%
\subsection{Visualise distance to roads and nearest site}\label{visualise-distance-to-roads-and-nearest-site}}
