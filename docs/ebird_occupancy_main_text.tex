...
\subsubsection{Spatial filter}\label{spatial-filter}}
...
\subsubsection{Add decimal time}\label{add-decimal-time}}
...
\NormalTok{data10m <-}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{count}\NormalTok{(data10m, value) }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{n =}\NormalTok{ n }\OperatorTok{/}\StringTok{ }\KeywordTok{sum}\NormalTok{(n))}
\NormalTok{data10m <-}\StringTok{ }\KeywordTok{xtabs}\NormalTok{(n }\OperatorTok{~}\StringTok{ }\NormalTok{value, data10m)}

\CommentTok{# map rasters}
\NormalTok{\{}
  \KeywordTok{png}\NormalTok{(}
    \DataTypeTok{filename =} \StringTok{"figs/figLandcoverResample.png"}\NormalTok{, }\DataTypeTok{width =} \DecValTok{1200}\NormalTok{, }\DataTypeTok{height =} \DecValTok{1200}\NormalTok{,}
    \DataTypeTok{res =} \DecValTok{150}
\NormalTok{  )}
  \KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow =} \KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{, }\DecValTok{2}\NormalTok{))}
  \CommentTok{# rasterplots}
\NormalTok{  raster}\OperatorTok{::}\KeywordTok{plot}\NormalTok{(landcover,}
    \DataTypeTok{col =} \KeywordTok{c}\NormalTok{(}\StringTok{"white"}\NormalTok{, scico}\OperatorTok{::}\KeywordTok{scico}\NormalTok{(}\DataTypeTok{palette =} \StringTok{"batlow"}\NormalTok{, }\DecValTok{7}\NormalTok{)),}
    \DataTypeTok{main =} \StringTok{"10m sentinel data"}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"longitude"}\NormalTok{, }\DataTypeTok{y =} \StringTok{"latitude"}
\NormalTok{  )}
  \KeywordTok{plot}\NormalTok{(hills, }\DataTypeTok{add =}\NormalTok{ T, }\DataTypeTok{border =} \StringTok{"red"}\NormalTok{, }\DataTypeTok{col =} \StringTok{"transparent"}\NormalTok{)}
\NormalTok{  raster}\OperatorTok{::}\KeywordTok{plot}\NormalTok{(rasterAgg1km,}
    \DataTypeTok{col =} \KeywordTok{c}\NormalTok{(}\StringTok{"white"}\NormalTok{, scico}\OperatorTok{::}\KeywordTok{scico}\NormalTok{(}\DataTypeTok{palette =} \StringTok{"batlow"}\NormalTok{, }\DecValTok{7}\NormalTok{)),}
    \DataTypeTok{main =} \StringTok{"1km resampled data"}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"longitude"}\NormalTok{, }\DataTypeTok{y =} \StringTok{"latitude"}
\NormalTok{  )}
  \KeywordTok{plot}\NormalTok{(hills, }\DataTypeTok{add =}\NormalTok{ T, }\DataTypeTok{border =} \StringTok{"red"}\NormalTok{, }\DataTypeTok{col =} \StringTok{"transparent"}\NormalTok{)}

  \CommentTok{# barplots}
  \KeywordTok{barplot}\NormalTok{(data10m,}
    \DataTypeTok{xlab =} \KeywordTok{c}\NormalTok{(}\StringTok{"landcover class"}\NormalTok{), }\DataTypeTok{ylab =} \StringTok{"prop."}\NormalTok{,}
    \DataTypeTok{col =}\NormalTok{ scico}\OperatorTok{::}\KeywordTok{scico}\NormalTok{(}\DataTypeTok{palette =} \StringTok{"batlow"}\NormalTok{, }\DecValTok{7}\NormalTok{)}
\NormalTok{  )}
  \KeywordTok{barplot}\NormalTok{(data1km,}
    \DataTypeTok{xlab =} \KeywordTok{c}\NormalTok{(}\StringTok{"landcover class"}\NormalTok{), }\DataTypeTok{ylab =} \StringTok{"prop."}\NormalTok{,}
    \DataTypeTok{col =}\NormalTok{ scico}\OperatorTok{::}\KeywordTok{scico}\NormalTok{(}\DataTypeTok{palette =} \StringTok{"batlow"}\NormalTok{, }\DecValTok{7}\NormalTok{), }\DataTypeTok{alpha =} \FloatTok{0.8}\NormalTok{, }\DataTypeTok{add =}\NormalTok{ F}
\NormalTok{  )}
  \KeywordTok{barplot}\NormalTok{(data10m,}
    \DataTypeTok{xlab =} \KeywordTok{c}\NormalTok{(}\StringTok{"landcover class"}\NormalTok{), }\DataTypeTok{ylab =} \StringTok{"prop."}\NormalTok{,}
    \DataTypeTok{col =} \StringTok{"grey20"}\NormalTok{, }\DataTypeTok{border =} \OtherTok{NA}\NormalTok{, }\DataTypeTok{density =} \DecValTok{30}\NormalTok{, }\DataTypeTok{add =}\NormalTok{ T}
\NormalTok{  )}
...
\subsubsection{Plot climatic variables over elevation}\label{plot-climatic-variables-over-elevation}}
...
\subsubsection{Plot proportional landcover in elevation}\label{plot-proportional-landcover-in-elevation}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# plot figure as tilemap}
\NormalTok{fig_lc_elev <-}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(lc_elev) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_tile}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}
    \DataTypeTok{x =}\NormalTok{ elev, }\DataTypeTok{y =} \KeywordTok{factor}\NormalTok{(landcover),}
    \DataTypeTok{fill =}\NormalTok{ prop}
\NormalTok{  ),}
  \DataTypeTok{col =} \StringTok{"grey"}
\NormalTok{  ) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_fill_distiller}\NormalTok{(}
    \DataTypeTok{palette =} \StringTok{"OrRd"}\NormalTok{,}
    \DataTypeTok{direction =} \DecValTok{1}\NormalTok{,}
    \DataTypeTok{na.value =} \StringTok{"grey"}\NormalTok{,}
    \DataTypeTok{values =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{),}
    \DataTypeTok{labels =}\NormalTok{ scales}\OperatorTok{::}\NormalTok{percent,}
    \DataTypeTok{name =} \StringTok{"% area"}
\NormalTok{  ) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_y_discrete}\NormalTok{(}
    \DataTypeTok{labels =} \KeywordTok{c}\NormalTok{(}
      \StringTok{"Agriculture"}\NormalTok{, }\StringTok{"Forest"}\NormalTok{,}
      \StringTok{"Grassland"}\NormalTok{, }\StringTok{"Plantations"}\NormalTok{,}
      \StringTok{"Settlements"}\NormalTok{, }\StringTok{"Tea"}\NormalTok{,}
      \StringTok{"Water Bodies"}
\NormalTok{    )}
\NormalTok{  ) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}
    \DataTypeTok{breaks =} \KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{2500}\NormalTok{, }\DecValTok{500}\NormalTok{),}
    \DataTypeTok{labels =}\NormalTok{ comma}
\NormalTok{  ) }\OperatorTok{+}
...
\StringTok{  }\KeywordTok{labs}\NormalTok{(}
    \DataTypeTok{x =} \StringTok{"Elevation (m)"}\NormalTok{,}
    \DataTypeTok{y =} \StringTok{"Land Cover Type"}
\NormalTok{  ) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_test}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{legend.key.width =} \KeywordTok{unit}\NormalTok{(}\DecValTok{2}\NormalTok{, }\DataTypeTok{units =} \StringTok{"mm"}\NormalTok{)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{fill =} \OtherTok{NULL}\NormalTok{)}

\CommentTok{# export figure}
\KeywordTok{ggsave}\NormalTok{(fig_lc_elev,}
  \DataTypeTok{filename =} \StringTok{"figs/fig_lc_elev.png"}\NormalTok{,}
  \DataTypeTok{height =} \DecValTok{2}\NormalTok{, }\DataTypeTok{width =} \DecValTok{6}\NormalTok{, }\DataTypeTok{device =} \KeywordTok{png}\NormalTok{(), }\DataTypeTok{dpi =} \DecValTok{300}
\NormalTok{)}
\KeywordTok{dev.off}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  df <-}\StringTok{ }\KeywordTok{as_tibble}\NormalTok{(df) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{st_as_sf}\NormalTok{(}\DataTypeTok{coords =} \KeywordTok{c}\NormalTok{(}\StringTok{"longitude"}\NormalTok{, }\StringTok{"latitude"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{    `}\DataTypeTok{st_crs<-}\StringTok{`}\NormalTok{(}\DecValTok{4326}\NormalTok{) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{st_transform}\NormalTok{(}\DecValTok{32643}\NormalTok{) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{id =} \DecValTok{1}\OperatorTok{:}\KeywordTok{nrow}\NormalTok{(.)) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{filter}\NormalTok{(id }\OperatorTok{%in%}\StringTok{ }\KeywordTok{unlist}\NormalTok{(}\KeywordTok{st_contains}\NormalTok{(wg, .))) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{st_drop_geometry}\NormalTok{()}
\NormalTok{\})}
...
\NormalTok{readr}\OperatorTok{::}\KeywordTok{read_csv}\NormalTok{(}\StringTok{"data/results/distance_roads_sites.csv"}\NormalTok{) }\OperatorTok{%>%}
...
\begin{Highlighting}[]
\CommentTok{# write the mean and ci95 to file}
\NormalTok{sp_spec_data }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(scientific_name) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarise_at}\NormalTok{(}
    \KeywordTok{vars}\NormalTok{(nnb),}
    \KeywordTok{list}\NormalTok{(}\OperatorTok{~}\StringTok{ }\KeywordTok{mean}\NormalTok{(.), }\OperatorTok{~}\StringTok{ }\KeywordTok{sd}\NormalTok{(.), }\OperatorTok{~}\StringTok{ }\KeywordTok{ci}\NormalTok{(.), }\OperatorTok{~}\StringTok{ }\KeywordTok{min}\NormalTok{(.), }\OperatorTok{~}\StringTok{ }\KeywordTok{max}\NormalTok{(.))}
\NormalTok{  ) }\OperatorTok{%>%}
...
\NormalTok{readr}\OperatorTok{::}\KeywordTok{read_csv}\NormalTok{(}\StringTok{"data/results/dist_nnb_species_specific.csv"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{annotation_custom}\NormalTok{(}
    \DataTypeTok{grob =}\NormalTok{ hist_roads }\OperatorTok{%>%}\StringTok{ }\KeywordTok{ggplotGrob}\NormalTok{(),}
...
\StringTok{  }\KeywordTok{annotation_north_arrow}\NormalTok{(}
    \DataTypeTok{location =} \StringTok{"br"}\NormalTok{, }\DataTypeTok{which_north =} \StringTok{"true"}\NormalTok{,}
    ...
    \DataTypeTok{style =}\NormalTok{ north_arrow_fancy_orienteering}
\NormalTok{  ) }\OperatorTok{+}
...
\StringTok{  }\KeywordTok{theme_few}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme}\NormalTok{(}
    \DataTypeTok{legend.position =} \KeywordTok{c}\NormalTok{(}\FloatTok{0.9}\NormalTok{, }\FloatTok{0.55}\NormalTok{),}
...
\StringTok{  }\KeywordTok{geom_sf}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ wg, }\DataTypeTok{fill =} \OtherTok{NA}\NormalTok{, }\DataTypeTok{col =} \DecValTok{1}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{annotation_custom}\NormalTok{(}
    \DataTypeTok{grob =}\NormalTok{ hist_sites }\OperatorTok{%>%}\StringTok{ }\KeywordTok{ggplotGrob}\NormalTok{(),}
    \DataTypeTok{xmin =}\NormalTok{ bbox[}\StringTok{"xmax"}\NormalTok{] }\OperatorTok{-}\StringTok{ }\NormalTok{(bbox[}\StringTok{"xmax"}\NormalTok{] }\OperatorTok{-}\StringTok{ }\NormalTok{bbox[}\StringTok{"xmin"}\NormalTok{]) }\OperatorTok{/}\StringTok{ }\FloatTok{2.5}\NormalTok{,}
    \DataTypeTok{xmax =}\NormalTok{ bbox[}\StringTok{"xmax"}\NormalTok{],}
    \DataTypeTok{ymin =}\NormalTok{ bbox[}\StringTok{"ymax"}\NormalTok{] }\OperatorTok{-}\StringTok{ }\NormalTok{(bbox[}\StringTok{"ymax"}\NormalTok{] }\OperatorTok{-}\StringTok{ }\NormalTok{bbox[}\StringTok{"ymin"}\NormalTok{]) }\OperatorTok{/}\StringTok{ }\DecValTok{3}\NormalTok{,}
    \DataTypeTok{ymax =}\NormalTok{ bbox[}\StringTok{"ymax"}\NormalTok{]}
...
\StringTok{  }\KeywordTok{scale_colour_scico}\NormalTok{(}
    ...
    \DataTypeTok{na.value =} \StringTok{"indianred"}
\NormalTok{  ) }\OperatorTok{+}
\StringTok{  }\KeywordTok{annotation_north_arrow}\NormalTok{(}
    \DataTypeTok{location =} \StringTok{"br"}\NormalTok{, }\DataTypeTok{which_north =} \StringTok{"true"}\NormalTok{,}
    \DataTypeTok{pad_x =} \KeywordTok{unit}\NormalTok{(}\FloatTok{0.1}\NormalTok{, }\StringTok{"in"}\NormalTok{), }\DataTypeTok{pad_y =} \KeywordTok{unit}\NormalTok{(}\FloatTok{0.5}\NormalTok{, }\StringTok{"in"}\NormalTok{),}
...
\NormalTok{  ) }\OperatorTok{+}
\StringTok{  }\KeywordTok{coord_sf}\NormalTok{(}
    \DataTypeTok{expand =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{xlim =}\NormalTok{ bbox[}\KeywordTok{c}\NormalTok{(}\StringTok{"xmin"}\NormalTok{, }\StringTok{"xmax"}\NormalTok{)],}
    \DataTypeTok{ylim =}\NormalTok{ bbox[}\KeywordTok{c}\NormalTok{(}\StringTok{"ymin"}\NormalTok{, }\StringTok{"ymax"}\NormalTok{)]}
\NormalTok{  ) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{fill =} \StringTok{"checklists"}\NormalTok{, }\DataTypeTok{colour =} \OtherTok{NULL}\NormalTok{)}
\end{Highlighting}
...
\hypertarget{explicit-spatial-subset}{%
\subsubsection{Explicit spatial subset}\label{explicit-spatial-subset}}
...
\subsubsection{Prepare species of interest}\label{prepare-species-of-interest}}
...
\subsubsection{Prepare checklists for observer score}\label{prepare-checklists-for-observer-score}}
...
\subsubsection{Get landcover}\label{get-landcover}}
...
\hypertarget{filter-data-for-stats}{%
\subsubsection{Filter data for stats}\label{filter-data-for-stats}}
...
\hypertarget{get-observer-expertise-as-species-in-60-mins}{%
\subsubsection{Get observer expertise as species in 60 mins}\label{get-observer-expertise-as-species-in-60-mins}}
...
\subsubsection{Temporal subsampling}\label{temporal-subsampling}}
...
\hypertarget{getting-area-means}{%
\subsection{Getting area means}\label{getting-area-means}}
...
\hypertarget{proportional-landcover}{%
\subsubsection{Proportional landcover}\label{proportional-landcover}}
...
\KeywordTok{fwrite}\NormalTok{(dat.scaled, }\DataTypeTok{file =} \StringTok{"data/scaledCovs_2.5km.csv"}\NormalTok{)}
...
\KeywordTok{capture.output}\NormalTok{(all_null, }\DataTypeTok{file =} \StringTok{"C:}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Users}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{vr235}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Downloads}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{null_models.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{write.xlsx}\NormalTok{(det_dred, }\DataTypeTok{file =} \StringTok{"C:}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Users}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{vr235}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Downloads}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{det_dred.xlsx"}\NormalTok{)}

\CommentTok{# 2. Store all the model averaged outputs for each species and the relative importance score}
\KeywordTok{write.xlsx}\NormalTok{(det_avg, }\DataTypeTok{file =} \StringTok{"C:}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Users}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{vr235}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Downloads}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{det_avg.xlsx"}\NormalTok{, }\DataTypeTok{rowNames =}\NormalTok{ T, }\DataTypeTok{colNames =}\NormalTok{ T)}
\KeywordTok{write.xlsx}\NormalTok{(det_imp, }\DataTypeTok{file =} \StringTok{"C:}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Users}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{vr235}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Downloads}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{det_imp.xlsx"}\NormalTok{, }\DataTypeTok{rowNames =}\NormalTok{ T, }\DataTypeTok{colNames =}\NormalTok{ T)}

\KeywordTok{write.xlsx}\NormalTok{(det_modelEst, }\DataTypeTok{file =} \StringTok{"C:}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Users}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{vr235}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Downloads}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{det_modelEst.xlsx"}\NormalTok{, }\DataTypeTok{rowNames =}\NormalTok{ T, }\DataTypeTok{colNames =}\NormalTok{ T)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{write.xlsx}\NormalTok{(lc_clim, }\DataTypeTok{file =} \StringTok{"C:}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Users}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{vr235}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Downloads}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{lc_clim.xlsx"}\NormalTok{)}

\CommentTok{# 2. Store all the model averaged outputs for each species and relative importance scores}
\KeywordTok{write.xlsx}\NormalTok{(lc_clim_avg, }\DataTypeTok{file =} \StringTok{"C:}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Users}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{vr235}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Downloads}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{lc_avg.xlsx"}\NormalTok{, }\DataTypeTok{rowNames =}\NormalTok{ T, }\DataTypeTok{colNames =}\NormalTok{ T)}
\KeywordTok{write.xlsx}\NormalTok{(lc_clim_imp, }\DataTypeTok{file =} \StringTok{"C:}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Users}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{vr235}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Downloads}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{lc_imp.xlsx"}\NormalTok{, }\DataTypeTok{rowNames =}\NormalTok{ T, }\DataTypeTok{colNames =}\NormalTok{ T)}

\CommentTok{# 3. Store all model estimates}
\KeywordTok{write.xlsx}\NormalTok{(lc_clim_modelEst, }\DataTypeTok{file =} \StringTok{"C:}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Users}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{vr235}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Downloads}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{lc_modelEst.xlsx"}\NormalTok{, }\DataTypeTok{rowNames =}\NormalTok{ T, }\DataTypeTok{colNames =}\NormalTok{ T)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{write.csv}\NormalTok{(goodness_of_fit, }\StringTok{"C:}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Users}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{vr235}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Desktop}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Occupancy Runs}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{output}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{05_goodness-of-fit-2.5km.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{show-cumulative-weights-as-plot}{%
\subsubsection{Show cumulative weights as plot}\label{show-cumulative-weights-as-plot}}
...
\hypertarget{export-data-to-file}{%
\subsubsection{Export data to file}\label{export-data-to-file}}
...
\subsubsection{Get predictor effects}\label{get-predictor-effects}}
