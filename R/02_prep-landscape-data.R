## ----load_libs2, eval=FALSE, message=FALSE, warning=FALSE---------------------
## 
## # load libs
## library(raster)
## library(stringi)
...
## ----load_hills, eval=FALSE, message=FALSE, warning=FALSE---------------------
## # load hills
## library(sf)
...
## ----stack_rasters, eval=FALSE, message=FALSE, warning=FALSE------------------
...
## ----get_resampled_lc, eval=FALSE, echo=FALSE---------------------------------
## # mask by study area
...
## ----read_resamp_lc, eval=FALSE, message=FALSE, warning=FALSE-----------------
## lc_data <- raster("data/landUseClassification/lc_01000m.tif")
## lc_data[lc_data == 0] <- NA


## ----resample_env_data, eval=FALSE, message=FALSE, warning=FALSE--------------
## 
...
## ----plot_clim_elev, eval=FALSE, echo=FALSE-----------------------------------
## # make labeller
## chelsa <- c(
...
## ----prep_lc_elev, eval=FALSE, message=FALSE----------------------------------
...
## ----fig_lc_elev, eval=FALSE, message=FALSE, echo=FALSE-----------------------
