...
#' 
## ----show_dist_roads_nnb, , message=FALSE, echo=FALSE-------------------------
# read in and show
library(magrittr)
...
#' 
#' Figure code is hidden in versions rendered as HTML and PDF.
## ----plot_map_dist_roads, , echo=FALSE----------------------------------------
# plot on maps
ggplot() +
  geom_sf(data = land, fill = "grey90", col = NA) +
  geom_sf(data = wg, fill = NA, col = 1) +
