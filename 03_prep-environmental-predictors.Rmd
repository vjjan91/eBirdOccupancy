...
Note: Two other versions/runs tested the role of interannual variation in temperature/precipitation as well as temperature/precipitation seasonality
...
# load Bio 1 and 12
bio_1 <- raster("data/chelsa/CHELSA_bio1.tif")
bio_12 <- raster("data/chelsa/CHELSA_bio12.tif")
```
...
PLEASE NOTE: These predictors need not be prepared any longer as they are not being used for this version of the analysis. 
