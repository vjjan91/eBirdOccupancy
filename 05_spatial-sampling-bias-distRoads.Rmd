...
```{r, message = FALSE, echo = FALSE, fig.cap="Spatial sampling bias of eBird observations across the Nilgiri and the Anamalai hills. A large proportion of localities/sites were next to roads and were on average only ~300m from another locality/site. Each cell here is 2.5km x 2.5km."}
fig_checklists_grid
```
