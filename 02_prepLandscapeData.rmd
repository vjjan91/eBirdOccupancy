...
alt <- raster("C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\Elevation\\alt")
...
# list chelsa files
chelsaFiles <- list.files("C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\CHELSA\\", full.names = TRUE, pattern = "*.tif")
...
landcover <- "C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\landcover\\Reprojected Image_26thJan2020_UTM_Ghats.tif"
# get extent
...
gdalwarp(srcfile = landcover, 
          dstfile = "C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\landcover\\lc_01km.tif", 
...
# mask by study area
{
  ...
  lc_data <- raster("C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\landcover\\lc_01km.tif")
...
# map rasters
{
  png(filename = "C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\Figures\\figLandcoverResample.png", width = 1200, height = 1200,
      res = 150)
  par(mfrow=c(2,2))
  # rasterplots
...
# get names
land_names <- glue('C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\landcover\\landscape_resamp{c("01")}km.tif')
