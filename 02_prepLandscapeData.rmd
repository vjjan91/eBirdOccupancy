...
# to 10km from 1km
gdalwarp(srcfile = "data/landUseClassification/lc_01km.tif", 
         dstfile = "data/landUseClassification/lc_10km.tif", 
         tr=c(10000,10000), r='mode', te=c(e))
# to 25km from 1km
gdalwarp(srcfile = "data/landUseClassification/lc_01km.tif", 
         dstfile = "data/landUseClassification/lc_25km.tif", 
         tr=c(25000,25000), r='mode', te=c(e))
```
...
# get names
land_names <- glue('data/spatial/landscape_resamp{c("01","10","25")}km.tif')

# write to file
map2(land_stacks, land_names, function(x,y){
  writeRaster(x, filename = as.character(y))
})
```
