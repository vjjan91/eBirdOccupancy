...
fig_climate_elev <- wrap_plots(subplots_climate_elev, ncol = 2) &
...
fig_lc_elev <-
  ...
  labs(
    x = "Elevation (m)",
    y = "Land Cover Type",
    title = "NEEDS TO BE CHANGED WITH NEW RECLASS MATRIX"
  ) +
  theme_test() +
  theme(
...
ggsave(fig_lc_elev,
  ...
  height = 4, width = 6, device = png(), dpi = 300
)
dev.off()
```
