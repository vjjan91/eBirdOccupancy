...
fig_lc_roy_reclass =
  ...
  tm_raster(palette = c(viridis::turbo(11), "grey"), style = "cat",
            title = "Landcover")+
  tm_shape(hills)+
...
# make labeller
chelsa <- c(
  bio_15a = "Seasonality in Precipiation (CV)",
  bio_4a = "Seasonality in Temperature (CV)"
)
...
fig_lc_elev <-
  ...
  scale_y_discrete(
    labels = c(
      ...
      "Dry Grassland", "Plantation",
      "Settlement","Barren land","Cropland","Wetland",
      "Mixed Forest","Sholas"
    )
  ) +
  scale_x_continuous(
...
ggsave(fig_clim_lc_elev,
  ...
  dpi = 300,
  height = 130, width = 168, units = "mm"
)
```

![(a) Seasonality in precipitation and seasonality in temperature as a function of elevation is shown here. The coefficient of variation was calculated. (b) The proportion of land cover types varied across the study area as shown in this panel.](figs/fig_02_clim_lc_elev.png)
