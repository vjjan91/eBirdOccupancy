...
Read in the species as range restricted or wide ranging.

```{r}
species_data <- readxl::read_excel("data/results/all_hypoComparisons_allScales.xlsx")
```
...
data_predictor_effect <- left_join(data_predictor_effect, species_data,
                                   by  = c("Scientific_name" = "Scientific.name"))
data_predictor_effect <- mutate(data_predictor_effect,
                                species_distribution = if_else(as.logical(`Range-Restricted`),
                                                               "range restricted",
                                                               "wide ranging"))
...
data_predictor_effect <- mutate(data_predictor_effect, 
  ...
  count(scale, predictor, species_distribution, direction) %>% 
