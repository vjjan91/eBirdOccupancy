...
specieslist <- read.csv("C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\2_List_of_species.csv")
...
write.csv(tot_n_chklist,"C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\nchk_per_grid.csv", row.names = F)
write.csv(spp_grids,"C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\ngrids_per_spp.csv", row.names = F)
...
grid_prop_cut <- grid_proportions[grid_proportions$prop_grids_cut>=0.5,]

# Write the results
write.csv(grid_prop_cut,"C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\chk_3_percent.csv", row.names = F)
...
# export data
ggsave(plotNchk, filename = "C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\fig_number_checklists_10km.png",height = 12,width = 7, device = png(), dpi = 300); dev.off()
...
# export data
ggsave(plotDistributions, filename = "C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\fig_species_distributions.png",height = 25,width = 25, device = png(), dpi = 300); dev.off()
```
...
write.csv(new_sp_list,"C:\\Users\\vr235\\Desktop\\Occupancy Runs\\Data\\3_List_of_species_cutoff.csv", row.names = F)
