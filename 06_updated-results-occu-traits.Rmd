...
ggplot(model_data)+
  ...
  geom_vline(xintercept = 0, col = "green",
             size = 0.1)+
  geom_point(aes(diff_elev, coefficient),
             size = 0.5, shape = 4)+
  geom_smooth(aes(diff_elev, coefficient),
              method = "glm", 
              se = F, size = 0.5)+
  scale_x_continuous(labels = scales::comma)+
  facet_grid(predictor ~ scale, scales = "fixed")+
  ylim(-5, 5)+
...
# export
ggsave("figs/fig_elev_diff_coeff.png", dpi = 300)
```
