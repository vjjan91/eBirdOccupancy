...
names(dat)
dat <- dat[, -c(1, 4, 5, 16,21,23,24,34, 35)]
...
names(dat) <- c(
  ...
  "longitude", "latitude", "expertise", "elev", "bio_15a.y", "bio_4a.y",
  "lc_02.y", "lc_09.y", "lc_01.y", "lc_05.y", "lc_04.y",
...
for (i in 1:length(unique(dat.scaled$scientific_name))) {
  ...
  occ_wide <- format_unmarked_occu(occ,
    ...
    response = "pres_abs",
    site_covs = c(
      "locality_id", "lc_02.y", "lc_09.y", "lc_01.y",
      "lc_05.y", "lc_04.y", "lc_07.y", "lc_03.y", "bio_15a.y", "bio_4a.y"
    ),
    obs_covs = obs_covs
  )
