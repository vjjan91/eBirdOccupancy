...
dat = dplyr::select(
  dat,
  c("duration_minutes", "effort_distance_km", "locality",
...
cols_to_scale = c("duration_minutes", "effort_distance_km",
...
cols_to_check = c("expertise", "bio15a", "bio4a", "lc_02",
                  "lc_09", "lc_01", 
                   "lc_05", "lc_04", "lc_07", "lc_03") 
...
for (i in 1:length(unique(dat.scaled$scientific_name))) {
  ...
  occ_wide <- format_unmarked_occu(occ,
    site_id = "site",
    response = "pres_abs",
    site_covs = c("locality_id", "lc_01", "lc_02", "lc_05",
      "lc_04", "lc_09", "lc_07", "lc_03", "bio15a", "bio4a"
    ),
    obs_covs = obs_covs
  )
