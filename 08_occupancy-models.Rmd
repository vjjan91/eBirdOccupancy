...
# NEVER EVER refer to columns by numbers, numbers change, names remain
# INSERT RELEVANT COLUMN NAMES
cols_to_scale = c("duration_minutes") # ADD MORE
...
cols_to_check = c("duration_minutes") # add more here
