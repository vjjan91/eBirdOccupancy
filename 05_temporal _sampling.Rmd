...
# get checklists
data = distinct(dataGrouped, sampling_event_identifier, observation_date,
  longitude, latitude)
...
# set all 0 to 1
data_lag = mutate(data_lag, mean_lag = mean_lag + 1,
...
```{r}
# save figure
ggsave(filename = "figs/fig_lag_spatial.png", width = 6.5, height = 6.5, 
       device = png())
```
...
# get fortnight
library(lubridate)
data = mutate(data, week = week(observation_date),
